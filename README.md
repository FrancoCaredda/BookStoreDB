...
|BK-005|Verify that there are no orders made in the future|Active connection to the database + imported data|1. Select orders with the order date greater than today; 2. Observe the results|No rows are returned|High|
